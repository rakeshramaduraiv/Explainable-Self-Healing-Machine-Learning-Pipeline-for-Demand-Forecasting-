...
import { ErrorBox, KPI, SectionCard, fmt, fmtK, fmtD, CHART_STYLE } from '../ui.jsx'
  ...
  return (
    <>
      ...
      <div className="kpi-grid">
        {loading
          ? Array.from({ length: 6 }).map((_, i) => <div key={i} className="kpi"><div className="skel" style={{ height: 60 }} /></div>)
          : <>
