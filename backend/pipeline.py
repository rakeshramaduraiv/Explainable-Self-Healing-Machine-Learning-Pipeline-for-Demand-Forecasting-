...
class Phase1Pipeline:
    ...
    def step6_generate_summary(self):
        ...
        if "severe" in severities:
            final_severity, recommendation = "severe", "Phase 2 required: Retrain model immediately"
        elif "mild" in severities:
            final_severity, recommendation = "mild", "Phase 2 recommended: Monitor and consider retraining"
        else:
